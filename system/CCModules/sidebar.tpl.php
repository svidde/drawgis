...
<div class='box'>
<h4>Drawgis core</h4>
<p>Drawgis core modules.</p>
<ul>
<?php foreach($modules as $module): ?>
  <?php if($module['isDrawgisCore']): ?>
  <li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
  <?php endif; ?>
<?php endforeach; ?>
</ul>
...
<div class='box'>
<h4>Drawgis CMF</h4>
<p>Drawgis Content Management Framework (CMF) modules.</p>
<ul>
<?php foreach($modules as $module): ?>
  <?php if($module['isDrawgisCMF']): ?>
  <li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
  <?php endif; ?>
<?php endforeach; ?>
</ul>
...
<div class='box'>
<h4>More modules</h4>
<p>Modules that does not implement any specific Drawgis interface.</p>
<ul>
<?php foreach($modules as $module): ?>
  <?php if(!($module['isController'] || $module['isDrawgisCore'] || $module['isDrawgisCMF'])): ?>
  <li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
  <?php endif; ?>
<?php endforeach; ?>
</ul>
